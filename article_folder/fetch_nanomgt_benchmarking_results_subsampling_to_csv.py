...
def process_datasets(base_path, output_file):
    ...
    json_info_path = f'/home/projects/cge/people/malhal/nanomgt_json/simulated_batches_clean'

    for maf_value in maf_values:
        param_path = os.path.join(base_path, f'maf_{maf_value}')
...
if __name__ == "__main__":
    base_path = '/home/projects/cge/people/malhal/depth_results/220_benchmark'
    output_file = '220_benchmark_metrics.csv'
