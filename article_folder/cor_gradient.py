...
def main():
    ...
    for result in results:
        print(f"MAF: {result['maf']:.2f}, Batch: {result['batch']}, First F1 Score: {result['first_f1_score']:.2f}, Last F1 Score: {result['last_f1_score']:.2f}, Lowest Slope Angle: {result['lowest_slope_angle']:.2f} degrees")
