...
for rate in bf:
    ...
    for folder in folders:
        cmd = f"confindr -i {data_dir_path}/{folder}/ -o /home/people/malhal/data/new_nanomgt/confindr_results/bf_{rate}/{folder} -d /home/people/malhal/contamErase/benchmarking/confindr/rmlst_db/ --rmlst -b 3 -bf {rate} -dt Nanopore -q 14 -t 4"
        os.system(cmd)
