...
for maf in maf_list:
    parameters = parameters_list[maf-1]
    new_output_folder = '/home/people/malhal/test/new_nanomgt_results/ii_search_output_{}/'.format(maf)
    os.makedirs(new_output_folder, exist_ok=True)
    ...
    for folder in file_list:
        if folder.endswith('merged'):
            ...
            if 'klebsiella' not in folder and 'salmonella' not in folder and folder.startswith('depth220'):
                run_jobs_in_parallel(40, new_output_folder, '/home/people/malhal/test/new_nanomgt_results/' + folder, maf/100, parameters)
