...
sequencing_ids = ['SRR25689478', 'ERR12533301', 'SRR26036455']
#This is an old reuse from when it was done for multiple species at once.
combined_list_of_ids = [sequencing_ids]
        ...
        for k in item:
            if j != k:
                ...
                with open('major_{}_minor_{}.txt'.format(k, j), 'w') as write_file:
                    #Adjust these paths to the folder in which the isolate alignments are located.
