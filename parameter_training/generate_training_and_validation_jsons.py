...
input_file_path = "clean_isolates.json"  # Replace this with your actual input file path
...
output_training_path = "training_set_clean_isolates.json"
output_validation_path = "validation_set_clean_isolates.json"
