...
for folder in folders:
    ...
    for file in fastq_files:
        ...
        # This trains new parameters from existing alignments to we won't have to realign for each paramters set.
        command = f"nanomgt --nanopore {input_file_path} --o {output_name} --threads 8 --db_dir ~/nanomgt_db/ --train"
